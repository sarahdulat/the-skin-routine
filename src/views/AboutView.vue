  ...
  <main>
    ...
    <div class="content">
      <div>
        ...
        <p>Hello, my name is Sarah and I am {{ currentAge }} old. Most people have a few questions upon hearing this,
          the
          first one is usually, "What?!" followed by, "What is your skincare routine?". This is when I have to admit
          that
          my daily skincare routine is actually a bit involved, and has been since April 2018. Not that I didn't take
          care
        ...
        <p>People asking about my skincare routine genuinely want to know the details, but when I start to rattle off my
          ...
          into
          a <a
            href="https://docs.google.com/spreadsheets/d/1PH3FHGTuFaOUuOaTCJxuLhv4Ril-zrSTL4Kd0aI74UA/edit?usp=sharing"
          ...
          "What if I have a smaller budget?". It was then that I decided to create a more interactive medium for not
          only
      ...
      <div class="image ms-xl pe-0">
        <img src="/images/Sarah-2.JPG?url" alt="Photo of Sarah">
